    ...
    return (
        <div className="min-h-screen flex bg-white">
            ...
            <div className="hidden lg:flex lg:w-1/2 bg-gray-900 relative justify-center items-center overflow-hidden">
                <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1542435503-956c469947f6?ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80')] bg-cover bg-center opacity-40"></div>
                <div className="relative z-10 text-center px-8">
                    <h1 className="text-5xl font-serif font-bold text-white mb-6">Start Writing</h1>
                    <p className="text-gray-300 text-xl max-w-md mx-auto">
                        Create an account to start publishing your own stories and interacting with others.
                    </p>
                </div>
            </div>
